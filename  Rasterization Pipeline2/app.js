...
function createScene() {
    ...
    groundGeometry.worldMatrix.multiply(new Matrix4().makeRotationX(90)).multiply(new Matrix4().makeScale(10,10,10));
    ...
    sphereGeometry.worldMatrix.multiply(new Matrix4().makeScale(0.01,0.01,.01));
}
// -------------------------------------------------------------------------
